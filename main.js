...
const createPlanetOverlay = (planet, clickedPlanet) => {
  if (planet) {
    ...
    0 0 0 5rem  ${borderColor2};" class="planets_planet bigInfoPlanet">${backArrow}</div>
